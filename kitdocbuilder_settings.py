##
# This module contains a number of setting for use by the kitbuilder code
...
PACKAGENAME = 'doc/dlkit/services'
...
##
# The directory for the doc source:
...
TEMPLATEDIR = 'builders/kitdoc_templates'
