...
class OsidProfile:
    ...
    get_display_name = """
        ...
        try:
            ...
            from osid_kit.dj_osid.common import DisplayText
    ...
    get_version = """
        import profile
        try:
            from installation_kit.dj_installation.primitives import Version
        except:
            from osid_kit.dj_osid.common import Version
        try:
            from type_kit.dj_type.primitives import Type
        except:
            from osid_kit.dj_osid.common import Type
...
"""
    ...
    get_id = """
        try:
            ...
            from osid_kit.dj_osid.common import Id
...
class OsidSession:
    ...
    get_authenticated_agent_id = """
        from authentication_kit.dj_authentication.objects import Agent
    ...
    startTransaction = """
        from osid_kit.osid_errors import ILLEGAL_STATE, OPERATION_FAILED, UNSUPPORTED
...
class OsidForm:
    ...
    def _init_metadata(self):
        from osid_kit.dj_osid.markers import Identifiable
        try:
            from id_kit.dj_id.primitives import Id
        except:
            from osid_kit.dj_osid.common import Id
...
class OsidObjectForm:
    ...
    def __init__(self): # In real world use this may never get called
        if osid_object_model:
            self.my_model = osid_object_model
        else:
            from osid_kit.dj_osid.models import OsidObject as osid_object_model
...
"""
    ...
    clear_display_name = """
        from osid_kit.osid_errors import NO_ACCESS
