##
# This module contains a number of setting for use by the aws adapter builder code
...
##
# The location of the directory that contains the patterns
PATTERN_DIR = 'builders/pattern_maps'

##
# The location of the directory that contains the templates
TEMPLATE_DIR = 'builders/awsosid_templates'
