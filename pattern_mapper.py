...
from pattern_mappers.objects import map_object_form_patterns,\
    ...
    map_catalog_query_patterns, map_catalog_node_patterns, map_catalog_form_patterns
...
def map_patterns(package, index, base_package=None):
    ...
    for interface in package['interfaces']:
        ...
        elif 'OsidCatalogForm' in interface['inherit_shortnames']:
            map_catalog_form_patterns(interface, package, index)
