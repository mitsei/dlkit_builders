...
from osiddocbuilder_settings import INTERFACMAPSDIRECTORY as interface_maps_dir
from osiddocbuilder_settings import XOSIDFILESUFFIX as xosid_suffix
from osiddocbuilder_settings import ABCROOTPACKAGE as abc_root_pkg
from osiddocbuilder_settings import ABCPREFIX as abc_prefix
from osiddocbuilder_settings import ABCSUFFIX as abc_suffix
#from osiddocbuilder_settings import MAINDOCINDENTSTR as main_doc_indent
from osiddocbuilder_settings import ENCODING as utf_code
...
def make_osiddocs(re_index = False, re_map = False):
...
#                                method['impl_notes_doc'].strip('\n')])
    ##
    # Uncomment the following for Sphinx-style doc details w/o implementation or compliance
    detail_docs = filter(None, [method['sphinx_param_doc'].strip('\n'),
                                method['sphinx_return_doc'].strip('\n'),
                                method['sphinx_error_doc'].strip('\n')])
