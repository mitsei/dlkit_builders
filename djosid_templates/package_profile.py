...
ID = {'authority': 'birdland.mit.edu',
      'namespace': '${osid_package}',
      'identifier': 'djosid'}

LANGUAGETYPE = {
    # The default language type identifier is required
    'identifier': 'ENG',
    # If the dj_locale service implementation is installed the following
    # elements are optional. If not, they must be filled in.
    'namespace': '639-2',
    'authority': 'ISO',
...
SCRIPTTYPE = {
    # The default script type identifier is required
    'identifier': 'LATN',
    # If the dj_locale service implementation is installed the following
    # elements are optional. If not, they must be filled in.
    'namespace': '15924',
...
FORMATTYPE = {
    # The default format type identifier is required
    'identifier': 'PLAIN',
    # If the dj_locale service implementation is installed the following
    # elements are optional. If not, they must be filled in.
    'namespace': 'Text Formats',
...
DISPLAYNAME = 'Django ${osid_package}'

DESCRIPTION = 'Django aware ${osid_package} implementation'
