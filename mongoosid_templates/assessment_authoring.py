...
class AssessmentPartAdminSession:
    import_statements = [
        ...
        'from ..assessment.assessment_utilities import get_assessment_part_lookup_session',
        'DESCENDING = -1',
        'ASCENDING = 1',
        'CREATED = True',
        'UPDATED = True',
...
class AssessmentPart:
    ...
    import_statements = [
        ...
        'from dlkit.abstract_osid.osid import errors',
        'from ..assessment.assessment_utilities import get_assessment_part_lookup_session, get_item_lookup_session',
