...
def map_object_data_patterns(interface, package, index):
    ...
    for method in interface['methods']:
        ...
        #    index[interface['shortname'] + '.persisted_data'][var_name] = method['return_type']"""
                ...
                var_name not in index[interface['shortname'] + '.persisted_data']):
            index[interface['shortname'] + '.persisted_data'][var_name] = method['return_type']
        ...
        # THIS MAY BE A MISTAKE
                ...
                ('Aggregateable' in interface['inherit_shortnames'] or
                 var_name == 'answers' or
                 var_name == 'question') and
                var_name not in index[object_name + '.persisted_data']):
        ...
        # return type.
                ...
                var_name not in index[object_name + '.instance_data']):
        ...
        # that haven't already been found.
                ...
                var_name not in index[object_name + '.instance_data'] and
